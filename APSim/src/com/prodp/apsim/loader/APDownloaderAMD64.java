...
/**
 * 
 * Downloads APSim for 64-bit systems.
 *
 */

public class APDownloaderAMD64 extends JFrame{
	
	/**
	 * The type of download.
	 */
	
	public final static String TYPE = "64"; //Either "64" or "i586"
	...
	public void init(){
		...
		if(dll1.exists() && dll2.exists() && dll3.exists() && dll4.exists()){
			dll1.delete();
			dll2.delete();
			dll3.delete();
			dll4.delete();
